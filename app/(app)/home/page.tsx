...
export const metadata = {
  title: "Home — AI Career Skill Coach",
};

/** The five stops, described rather than tracked — nothing has started yet. */
const STEPS = [
...
export default async function HomePage() {
  ...
  // The proxy already gates this route; checking again here is the pattern
  // Next's own auth guide asks for, since a proxy matcher change would
  // otherwise silently remove the only protection.
  if (!user) {
    redirect("/");
  }
